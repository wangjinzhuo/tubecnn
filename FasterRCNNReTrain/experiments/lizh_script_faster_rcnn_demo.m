...
%% -------------------- TESTING (consecutive frames) --------------------
close all;

imgPath = '/home/caffe/opticalFlow_sports/Diving-Side/001/im/';
testNum = 54;
start_index = 1;

for i = 1 : testNum
    im_names(i) = start_index + (i - 1);
end

running_time = [];
for j = 1:testNum
    
    im = imread(fullfile(imgPath, sprintf('image_%04d.jpg', im_names(j))));
...
%% -------------------- TESTING (frames with some space) --------------------
% imgPath = '/home/cnn/faster_rcnn/test/v_FloorGymnastics_g05_c04/';
% % im_names = {'image_0058.jpg', 'image_0059.jpg', 'image_0060.jpg', 'image_0061.jpg', 'image_0062.jpg', 'image_0063.jpg', 'image_0064.jpg', 'image_0065.jpg', 'image_0066.jpg'};
% % these images can be downloaded with fetch_faster_rcnn_final_model.m
% 
% totalFrameNum = 69;
% testNum = 9;
% space = floor(totalFrameNum / testNum);
% for i = 1 : testNum
%     im_names(i) = space * i;
% end
% 
