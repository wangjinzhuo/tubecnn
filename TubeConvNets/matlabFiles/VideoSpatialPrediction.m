function prediction = VideoSpatialPrediction(vid_name, vid_leng, mean_file, net)
num=25;
...
for i = 1:num
    ...
    img_path = fullfile(vid_name, sprintf('image_%04d.jpg', frame_index));
    img = single(imresize(imread(img_path{1}),[256,340]));
    rgb(:,:,:,i) = img;
